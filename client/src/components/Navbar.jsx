...
const Navbar = () => {
  ...
  return (
    <>
      <header className="fixed top-0 w-full z-40 bg-white/80 backdrop-blur-lg border border-gray-20 shadow-sm">
          ...
          <div className="flex items-center justify-between h-full">
            ...
            <div className="flex items-center gap-8">
              ...
              >
                ...
                <h1 className="text-lg font-bold text-gray-800">ChatZone </h1>
              </Link>
            </div>
